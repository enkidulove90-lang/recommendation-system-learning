...
- **数据与任务设置**：数据集：Amazon CDs_and_Vinyl、Amazon Cell_Phones_and_Accessories、Amazon Fashion；任务：Experiments Datasets.；划分：leave-one-out
- **基线与对照**：Following previous work (Zhang et al., 2024; Huang et al., 2023b,a, 2024b), we conduct experiments on three text-intensive subsets of the Table 1: Performance comparison on three domains.；denotes the relative improvement of our method over the strongest baseline.；Baselines.
- **评价指标**：N@1、N@5、N@10、MRR、NDCG@5
- **实现环境与关键参数**：原文未披露
